...
//	go build -ldflags "-X github.com/ryanleesmith/protobuf-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/ryanleesmith/protobuf-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
